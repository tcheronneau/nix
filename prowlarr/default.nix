...
let
  ...
  hash = {
    x64-linux_hash = "sha256-fQqAP4mcon9dfLA+YJRN8kD+m4/1JmtgIn32XckhNrc=";
    arm64-linux_hash = "sha256-5Tvsh4pblHo1rNOXtKONThmdW12Vp5xSOAY/Sr4P52o=";
    x64-osx_hash = "sha256-AtB3QlAEmtfmM4ufk5fSGuJUgOaHNS/uuErQQ1dveR8=";
  }."${arch}-${os}_hash";

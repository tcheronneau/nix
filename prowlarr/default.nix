...
let
  ...
  hash = {
    x64-linux_hash = "sha256-U7EKkiy1wXd2Lw76yD7gDuqcBFn0yUXAc2W/5sJM+oY=";
    arm64-linux_hash = "sha256-VCmyaRhy+9XRoY60ALlyecjBsWFKKjkTQwZHysGMgiU=";
    x64-osx_hash = "sha256-QDS1j/J91awz1d7kv58o09twMNcj+gUJfpkJPzT6uH4=";
  }."${arch}-${os}_hash";

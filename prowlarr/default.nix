...
let
  ...
  hash = {
    x64-linux_hash = "sha256-3vx0bYXchvosHCvr2FLdN1We6798WgJFOcV1M5ZTh7g=";
    arm64-linux_hash = "sha256-7eMquL83xo5Vw3p4dwfwyA/U5RV94tyFKgh4tsFkOY0=";
    x64-osx_hash = "sha256-aJEV1UTMTlkMBXdaGMGLDq7/kFLeqfxCOVV5PqKPs5k=";
  }."${arch}-${os}_hash";

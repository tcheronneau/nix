...
let
  ...
  hash = {
    x64-linux_hash = "sha256-8jktaTWcUov/iqiGJ5/FVzaW32zJnvtopbP5T4gopgg=";
    arm64-linux_hash = "sha256-zW2IKwLM6TlxmUVydf1ofnMASDU6HuEz+33OmxEg7OY=";
    x64-osx_hash = "sha256-mmReJnP+OEZD4yzHxIHrU4k6klX5M5fLCznWpyS/bV0=";
  }."${arch}-${os}_hash";

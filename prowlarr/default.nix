...
let
  ...
  hash = {
    x64-linux_hash = "sha256-P4wiq7B9bWIpqeiyD0f7GCi7jpj1Wjk55i1Fre+FwT8=";
    arm64-linux_hash = "sha256-oSY7/eJv06gRY6i4LmeedbvJgntsrOMI5RJQH88eYbg=";
    x64-osx_hash = "sha256-QzLczg/a9EcZCn5GqkNteztMqZuJjwKJErtKhHxeN/8=";
  }."${arch}-${os}_hash";

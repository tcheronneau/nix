...
let
  ...
  hash = {
    x64-linux_hash = "sha256-IOFPN7ZMqLlRieJNRnGQhiJNiJ3G53zOFym27F9Mz7o=";
    arm64-linux_hash = "sha256-HvfKT2teXbcVexvmJvob7dw25zzh6HOo0KDDYbjcbJw=";
    x64-osx_hash = "sha256-HT4s6sG7IB+FIsQ/XJDwBD09mqD89tAFX5QH8Deb22I=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-5a/w7EOefp6016Y/X0kKYs1zNaNldUuWQyRkrxOdiDA=";
    arm64-linux_hash = "sha256-kOUUSoApgDqpePWJbzmHsvGNdaz5W/Dc/zXfLrn10Z4=";
    x64-osx_hash = "sha256-5ePkcoVnzk6g9f70CSKm81eZCW0F/fwNeFv3ANYE9Sc=";
  }."${arch}-${os}_hash";

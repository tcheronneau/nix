...
let
  ...
  hash = {
    x64-linux_hash = "sha256-aBtl6aotoOHKrND2YkR/1H2tKe9KpOJRhKNrmXfFyMM=";
    arm64-linux_hash = "sha256-2ofxzTMMhxsoOqmTBsg++1VXqJpycnyovrwYfEXOj/k=";
    x64-osx_hash = "sha256-uVJBFMreV4oKHL0oHPjMnotWD/3TgdqVBn7+v21GLBg=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-Ra4XnAmYPcpEWXYQ+fMeJYSKIYK0z0tbxMJJP3uAG54=";
    arm64-linux_hash = "sha256-diguhu4F+f9G6EtHHyMJcJ1u7j1VE1AEwebuCVu17t0=";
    x64-osx_hash = "sha256-Bc/bNKTmJHcNxs8UBE1QOEjk4f9k8KnG3+msVWyikzA=";
  }."${arch}-${os}_hash";

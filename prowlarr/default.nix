...
let
  ...
  hash = {
    x64-linux_hash = "sha256-C9UUQR6wjMJUEuh8q3fZ1osclVDbBT1GKGWB4W0qWjE=";
    arm64-linux_hash = "sha256-FDh86H8Gh2ZdEjD0bbgaqdDyfBJ47Vn/aTAcCiQXkIA=";
    x64-osx_hash = "sha256-yQvFqoKcgj64pZordWjEnyx7gp/WayXwvkJ3GUUeGDE=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-IS7tbXbmCHcgVRM4xmxHweqy3ntomkONeCyxdIQcn8I=";
    arm64-linux_hash = "sha256-BY1U+6nzi9q1//K6jUzA1ayq4voc6C+Mf+qBml2g91g=";
    x64-osx_hash = "sha256-2q1fcXkAqcteHqNwzuhEvHkmlWnnDAFy16LJp++QNcM=";
  }."${arch}-${os}_hash";

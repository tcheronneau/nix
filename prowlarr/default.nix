...
let
  ...
  hash = {
    x64-linux_hash = "sha256-UJAO0nS9dqut/vp4un7HB3++KGYqCGCmOGkqh5vBpvo=";
    arm64-linux_hash = "sha256-q0ZrWJc10CajljLLzN5Ri/wjCa6cIdWarHt6H9J0/44=";
    x64-osx_hash = "sha256-6w0hDMV2GT8uHxe0n2QxUMnwD8Muslj0HLPHkX0ws8w=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-zFZ6b/uw7C6igExh9xDOK8JfwCUO3akubu57L72atTA=";
    arm64-linux_hash = "sha256-VgBh1dwMu2QmlUC8L2nGjTH0PPGdtTwoeGZys6rGgdE=";
    x64-osx_hash = "sha256-PHkhPatRzqyHrRRlrnBQvwZus9t/Nk+UCaYKAEShlhY=";
  }."${arch}-${os}_hash";

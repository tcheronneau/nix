...
let
  ...
  hash = {
    x64-linux_hash = "sha256-lqGRTczk6vmG+gy4IP/Y2qqKfd7ddGLgLQpafzI6hyo=";
    arm64-linux_hash = "sha256-RDw70aKTt1E6lcwoiqpcQ2RyrfjgbkYhs8sq8TRYQaw=";
    x64-osx_hash = "sha256-VCPO04WzElecBu1L+mAsLn57y0oOU2gDg5FEHnoj2Zs=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-glqhtTs+U3WOwQS7+UzpawDReKXbiZMf3vH2FNXOwHw=";
    arm64-linux_hash = "sha256-m8eTwF8/1LEGS9tXCLnpfdpfSdnBNVGwxabWPu/cXy8=";
    x64-osx_hash = "sha256-2H2xXP/0sDC7rSPG/rKesRie+zj6ynDiivA/Lax8ZWw=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-EPFtB4xUGKa5p0AeS5xlsQ7GUu+K4fraXjKLGyZDgeA=";
    arm64-linux_hash = "sha256-zp3e8/Yi0ayzS/1F/VXp2UFt+uyHa7yZcBySf2RuoiA=";
    x64-osx_hash = "sha256-j13gSFBzfAdsfcIzlCF/wsx+6GqvaYLtFk5C6q1MNzY=";
  }."${arch}-${os}_hash";

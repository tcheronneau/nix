...
let
  ...
  hash = {
    x64-linux_hash = "sha256-LlbrCAdRWUVUDvbtvFUvtxh5JqcbW478R/wnernn0zA=";
    arm64-linux_hash = "sha256-SHWhPAwq+dykhxJmCUgI7+WPriv/xiky9Ab53JYm1hM=";
    x64-osx_hash = "sha256-BCbjAsF5A7EKo+yLcsLVRZu+r1t7v7wTSCTs2t2qnFg=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-mJgXPCZ1sKDIfcBDMMgqqBj1Fxx+8WS1qT9rXBw+9pQ=";
    arm64-linux_hash = "sha256-Len2OF/UnksqvxO/Z/3vOqA3XoZ/ILm9rU8uo25EYpU=";
    x64-osx_hash = "sha256-kpnzLQzWsWIp3ei+mOOU+02mtfUDRUbkl8tZ6WJWYmY=";
  }."${arch}-${os}_hash";

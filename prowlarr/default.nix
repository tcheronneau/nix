...
let
  ...
  hash = {
    x64-linux_hash = "sha256-DQspVa4zMmrfCJbzX09T1Gh0cpK5r1vQthDSKP7BTfQ=";
    arm64-linux_hash = "sha256-Ez8i37hJ1ZBwfBbvHqgYzKBzNq0yvXZBIkVUIurMvZE=";
    x64-osx_hash = "sha256-5H7bfj7zUTOsek9b2kQUvq86LPs/QxAO5blQ3HUtrKY=";
  }."${arch}-${os}_hash";

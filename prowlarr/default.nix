...
let
  ...
  hash = {
    x64-linux_hash = "sha256-Ql6ag0+Kds753r86htxqDe5h0djOC1LTm10EMpNWkPw=";
    arm64-linux_hash = "sha256-4INP7+uh9i8v/t5Kp7gG6O240KWnwoD8XMhUdZSsDYg=";
    x64-osx_hash = "sha256-CYHVLI0VonWUoKOjhHurzvwU7J5+Es1hyQFJ4ts5m1w=";
  }."${arch}-${os}_hash";

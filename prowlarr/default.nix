...
let
  ...
  hash = {
    x64-linux_hash = "sha256-5olgWmMJE3WaoFGnnzjLjiHPUC18dHa5dpQPL4xUk+4=";
    arm64-linux_hash = "sha256-Pu5jBNBVzhmfAhDmLSpNOYbYDIamzTBcHkyRH3Vh3dc=";
    x64-osx_hash = "sha256-FIXuylJ8I2PsUUsIO1qf7VNClcGMRkRDhhxiSbMtE3Y=";
  }."${arch}-${os}_hash";

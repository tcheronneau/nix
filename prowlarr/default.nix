...
let
  ...
  hash = {
    x64-linux_hash = "sha256-PMAfz9Fgr/SBlwQ5TB//NTqfTUfxL+Zd+uJYjbWRsiQ=";
    arm64-linux_hash = "sha256-jvRTlKsxo/Oa0TO6EeFwmhVAV9SE8Kgy3Y8kS1eIbA0=";
    x64-osx_hash = "sha256-FBfDOQvN+8YmOYq69WrzZdwmcalkUz2hoiBmm01bvdw=";
  }."${arch}-${os}_hash";

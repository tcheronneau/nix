...
let
  ...
  hash = {
    x64-linux_hash = "sha256-wYXwi9bqUi2TwxRcT0rzMqTcXMV5wQmjweo7h6VmjNY=";
    arm64-linux_hash = "sha256-jvPL4bSvnjYEIJxS0sQT9LyrOVgCIUDDaf4ElE2nRA4=";
    x64-osx_hash = "sha256-tmZnPWf6Z2sq+ikfqdCq6ZlZ4hv72ph+pKjt2nDWZN0=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-18CZDa6AujxzqtBt/s7qyyq6vtf6B03B7fiELY6uy2Q=";
    arm64-linux_hash = "sha256-oR/grttSyhWLxn5kOi8fxIsfEm0TDwclzEQIXhYlQ6g=";
    x64-osx_hash = "sha256-0EmZdXeLgefGj4Z6jTNqcoOFiURBxHTNQcHdP2qY4IE=";
  }."${arch}-${os}_hash";

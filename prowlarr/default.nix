...
let
  ...
  hash = {
    x64-linux_hash = "sha256-kyJ3A9cLq8OUTtCiHEmUGOteOBbspBvE/dJtKqH0hho=";
    arm64-linux_hash = "sha256-GDSGSSLS78d3qs7KSs6cpUGHPpldrAZ/CFJRKFQ/HEQ=";
    x64-osx_hash = "sha256-ehzZKnMZVODVFKzIu43DQ/cCEtaGpzMwD6ByqhFE0X0=";
  }."${arch}-${os}_hash";

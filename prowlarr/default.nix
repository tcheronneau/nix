...
let
  ...
  hash = {
    x64-linux_hash = "sha256-Nz1v/ecilXdkmasL35CWCzwUDy1KAYkcZvvSrjH5jqY=";
    arm64-linux_hash = "sha256-IqPdWGar370ertnnApQXlDIy6iX0TucYTMzfEm7lPWY=";
    x64-osx_hash = "sha256-74y/nnS215g+P3TOYdOU+4Y/ssH9nE5JmdvCvKpBFiQ=";
  }."${arch}-${os}_hash";

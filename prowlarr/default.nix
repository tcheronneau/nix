...
let
  ...
  hash = {
    x64-linux_hash = "sha256-GDEaQvOYEPLkqh2GK4oWcLMumb1qBMGdqvz/F/qfurI=";
    arm64-linux_hash = "sha256-+EUU3ecmA6RLJsJkKnui98/2HnApUWXnyhnFcKvcWo4=";
    x64-osx_hash = "sha256-h2qqP08kAkgK9+7dO7Rgf9Ij7gQSNJCWAMhGfHEIM0c=";
  }."${arch}-${os}_hash";

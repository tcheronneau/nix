...
let
  ...
  hash = {
    x64-linux_hash = "sha256-anL2yBYlSpC/Pv9EFqW38ZQa34+If46QsTjPR7sV+C8=";
    arm64-linux_hash = "sha256-Me7SU5iom7+Cru8xfDDm5rfpbygrO4ZDJgbq/tzP9dA=";
    x64-osx_hash = "sha256-LO5uqYuLS3mxw9gXQEuDk/mIL7KXeRJBa7/WfFmavqQ=";
  }."${arch}-${os}_hash";

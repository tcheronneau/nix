...
let
  ...
  hash = {
    x64-linux_hash = "sha256-yXsvxx6y4qmIklmbk4OWy2jyp3ZNBLeQrZuyJ7NH+kE=";
    arm64-linux_hash = "sha256-MOYt9KYnMpOnVBh+C7l9UKVUKzZBSCfN/1OZNKvGhlY=";
    x64-osx_hash = "sha256-2o/gLuU6H0/pxKGhyVXWEGBMgKydFQgqbyPnruOdXTk=";
  }."${arch}-${os}_hash";

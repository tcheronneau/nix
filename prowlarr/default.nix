...
let
  ...
  hash = {
    x64-linux_hash = "sha256-lcEoXShlE/6VZXZykb3pOUD9tDLbrT/dQfqmD3PqvMo=";
    arm64-linux_hash = "sha256-PlS+xgvvcppQqS1dvuPH36CwZwdN5PFF0lz9xqECMU8=";
    x64-osx_hash = "sha256-sGzoCH+0AsxhcFU1RCvIXiUEOwbjPKsFuw20U8WG8ts=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-/Qae2tkfzFRB3kdT3BN54tF8nHluo8lTZMsdqWyYcUs=";
    arm64-linux_hash = "sha256-H+P73unFmFnm/ART7MclX9VbGFfoNCijQPBzpL/TfUs=";
    x64-osx_hash = "sha256-3pGX3+Lm0X4riYRubTMYn1vy2sZ0ZBppszSET7DM+kg=";
  }."${arch}-${os}_hash";

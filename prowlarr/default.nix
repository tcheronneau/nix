...
let
  ...
  hash = {
    x64-linux_hash = "sha256-GGplGMK6r1WKzseKfYtefwqwwh0Iju85lYF8pqmCBZA=";
    arm64-linux_hash = "sha256-fGbLgThVJ5SmgcxhJSjZvywq8PPzPITC6wW+ltZifwk=";
    x64-osx_hash = "sha256-stLNk0D0NQKGI2aW4B3HxEOfAIduVLcHjeld1jwNBb4=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-GWUTEEW+QjxNfBPZYrMI+vHKfXRZZvV9kswwj1By32U=";
    arm64-linux_hash = "sha256-6qRsgoFvfB61dwSPJQMauRaVagwG+1Pq4erwqGopP14=";
    x64-osx_hash = "sha256-H6wgyNfEymRQG6JJy6CLgAwfFFKr7CmkvcDTItDNbhc=";
  }."${arch}-${os}_hash";

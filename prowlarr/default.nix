...
let
  ...
  hash = {
    x64-linux_hash = "sha256-XtC12VhWhJtiJ6sGafYAthZRLZV8n7w+qcbe1DbbY4E=";
    arm64-linux_hash = "sha256-6zcA/N2zHEcOi/hzWJijVb1ka6EOsb+qwDyFQULZTi4=";
    x64-osx_hash = "sha256-uaeDpNX/HIOMEg3hNZDgo+Gmn/3pxU4xXgFseR3ist8=";
  }."${arch}-${os}_hash";

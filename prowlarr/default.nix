...
let
  ...
  hash = {
    x64-linux_hash = "sha256-cMKiAPkLXmAjmwygy6Lth5zjHzvmjPG/5nbmswKSqdA=";
    arm64-linux_hash = "sha256-9pebjPFy0skY3CpSC4Lg7tCdq83gLopPlhwj2iYYFEM=";
    x64-osx_hash = "sha256-ZOkGBC3lMP5GwylFrgvy6URTNM8x3YSOa1puXoX7ZsI=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-nMWXcpiKvNUZaUm4hEd+W6A8QpGXV040059ZyU2SWm8=";
    arm64-linux_hash = "sha256-TWuIYXMvGmNazzYUBpDQddVBQ18fUrCQmKpZzu4bLUY=";
    x64-osx_hash = "sha256-gjuW5m6kEwj6SIALZpetItv/LuM9y1lxaOE2IZjjAhI=";
  }."${arch}-${os}_hash";

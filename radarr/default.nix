...
let
  ...
  hash = {
    x64-linux_hash = "sha256-w+vRePvF6eMi0fwvb/eq0RymOyCHaKz423JLebWBX68=";
    arm64-linux_hash = "sha256-uiNSyWDo0O5+p3Vuzp6n90OatxOrl7mawcaJ2qFT52E=";
    x64-osx_hash = "sha256-+bKFWFrTH8y0sNbf52ilNK42x5w/0gFuGzU4ob2fhsI=";
  }."${arch}-${os}_hash";

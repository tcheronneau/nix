...
let
  ...
  hash = {
    x64-linux_hash = "sha256-jiboeqJZpLipkRRQt6fgl+eCu62GCMGnQTLtjaxjwGA=";
    arm64-linux_hash = "sha256-IVESJHN3wUz7tfHkd5GVvUmjswLEl9uh5euPNertsuc=";
    x64-osx_hash = "sha256-83ghGKnzyIAI6kmFuBCqZ3NI/Y1cWFLVT8SkTy0xwCM=";
  }."${arch}-${os}_hash";

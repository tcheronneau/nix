...
let
  ...
  hash = {
    x64-linux_hash = "sha256-u0COEWCFzcGjYsVsonWg/YCmE4WfWT+AKcJlTKKt7Ak=";
    arm64-linux_hash = "sha256-jph7zd2Ft3DWLDHiM/XgxOcgfyCjkCp6ioOUNpX31ic=";
    x64-osx_hash = "sha256-qw1CpKTjIjhuOXMSW57pO5lcWcVHh6SbJYwCKQfGOC8=";
  }."${arch}-${os}_hash";

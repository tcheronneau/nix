...
let
  ...
  hash = {
    x64-linux_hash = "sha256-Hd3YvBCHIV1LbRL0fIEMPPrzL6qs2pTjoIGWHWKjyj8=";
    arm64-linux_hash = "sha256-Bd5i7OMXhe0OixQqDoHpzLUuc+h+2nm7ArVZCEZS4Rs=";
    x64-osx_hash = "sha256-F/vGQX3CKb1ZiP2DMbhhqw7/myWt99XmzleLbPugTj0=";
  }."${arch}-${os}_hash";

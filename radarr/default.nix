...
let
  ...
  hash = {
    x64-linux_hash = "sha256-s1bfrJUiEVxZqBGQj6YL+SPqxI2xIrP53IpoVZKsONo=";
    arm64-linux_hash = "sha256-KeeVRdIxQmjPpp3cIdJa/1+Dd8Vbbbd6SXxEWXXDUtU=";
    x64-osx_hash = "sha256-OwQhNHRYfV4/3W1H7rGd3p4P4BlCCqtqlAUP1qv02y8=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-Hlaj0LQbYNMUYi4Ga9L6zt/cpfxW0RBV+FTQi9f2SJU=";
    arm64-linux_hash = "sha256-4EsymxQoNgfQBWOyLsXoko9723uh+G9Y3A4WbUsQdhc=";
    x64-osx_hash = "sha256-6VTyvJQAtZCHK3aQJ/fuejKMVHZIyf2VestNTQtlvv4=";
  }."${arch}-${os}_hash";

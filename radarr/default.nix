...
let
  ...
  hash = {
    x64-linux_hash = "sha256-lRgCA2WF3AP4j9qxw5XqONa2Qi8DRQ4QcMmFMSmCkUc=";
    arm64-linux_hash = "sha256-MfabibAvYcMT6VQAOpa3cZpz0S2pgbBGw53cnFA42t4=";
    x64-osx_hash = "sha256-5ZrkHPTlW8K7h0y8Ml5iPv+IetVRJlZL70Pq0+DsLZo=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-nZosOWuePyryEkJhjodYC6lygIObaRlP9dmcdANm5EE=";
    arm64-linux_hash = "sha256-uD1gKl09fON26AM0wipmA4Ve28IaLbZYwC3b26YkNwE=";
    x64-osx_hash = "sha256-ipj1fhmjICeJ1CXSmU3yD+Wat1jI34Pq9HnCTNPgObA=";
  }."${arch}-${os}_hash";

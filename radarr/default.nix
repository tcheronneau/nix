...
let
  ...
  hash = {
    x64-linux_hash = "sha256-YsCNX+AhSKhhQt3FL+9uYCt4ZmjgsLrrZTdQ/DwLpeM=";
    arm64-linux_hash = "sha256-IaqpK1+bT/YLcYDsMrhHArnIas6KxUziuI51+wHrhp4=";
    x64-osx_hash = "sha256-2fJ340FL3Lal6GFhuTzWHhiyy8m1XO/Rex/kfmR4DpY=";
  }."${arch}-${os}_hash";

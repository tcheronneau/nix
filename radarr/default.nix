...
let
  ...
  hash = {
    x64-linux_hash = "sha256-x99lxSNRCnz77DhX1xcw9NnpMQKNz+IcQVZAetbuHlg=";
    arm64-linux_hash = "sha256-zb4ZbVgrS3BNknzOZlVHP8jRENuXhDGiRUu4cGqoSyA=";
    x64-osx_hash = "sha256-7w+do736qPsqaBFJ2OWHUgeJ6nDeNA6kOMmeB4q/KLQ=";
  }."${arch}-${os}_hash";

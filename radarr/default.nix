...
let
  ...
  hash = {
    x64-linux_hash = "sha256-n1DMuns7Yp6IB6WbhzRLSZAjb6xym0uZ7Hvq36YY6kI=";
    arm64-linux_hash = "sha256-iMfYT6sWF5srkaUkCaK1L5PgTL4vfHIrLQKAhiEDMeo=";
    x64-osx_hash = "sha256-FyR3pqSdNmmLWuV7viLH2hYERIxIV+t2GOpXu098tz8=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-f/wg4WKNf/BAto8wWAu56viKCqHDEExIr2D05ZLhdi8=";
    arm64-linux_hash = "sha256-FiozReDCmf+0IgzQCzJXOPhmZvp4RNbGTqlFoFfU7dI=";
    x64-osx_hash = "sha256-qlmfZnYYsQ/WxkZ7Ttx0Tmpq6SlT6tXDyRUiFiEG1WA=";
  }."${arch}-${os}_hash";

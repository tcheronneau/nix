...
let
  ...
  hash = {
    x64-linux_hash = "sha256-TUtfQxfS9jXswY5eAeWhRzk2nShYbqjquzKfYlWWAho=";
    arm64-linux_hash = "sha256-wkh8xr+SXWbl11r1wX5TeJw/FxbD5jr3/sXOQJkeK+0=";
    x64-osx_hash = "sha256-dXuRz3V+JattDaoP4li97PX5JZz7jINKwLb9Ey1Yk2E=";
  }."${arch}-${os}_hash";

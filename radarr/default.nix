...
let
  ...
  hash = {
    x64-linux_hash = "sha256-piwjlJucX5rujiyYbvUZY83TTaB1SK05GtDYCAEHl/A=";
    arm64-linux_hash = "sha256-AldQQZc6n/spdVpNF+39+l9HVSDSbsGjL9svzx5KNkg=";
    x64-osx_hash = "sha256-v1/+9BpWuX5Ndz6oLGYDEklXpTaks1VkahF80yfI9SI=";
  }."${arch}-${os}_hash";

...
let
  ...
  hash = {
    x64-linux_hash = "sha256-A9O1BsN/xTFLRkDktqJIZbmb60VKHxyPlbCnxKXcn1k=";
    arm64-linux_hash = "sha256-P9Y5+o0xs4aNetcyt1/MpAe56DH07pX4KMTbX0EJDiI=";
    x64-osx_hash = "sha256-0FeQ4179B53y1ZeZ40ldLbZaRmDO9KgxGnmdETRe91c=";
  }."${arch}-${os}_hash";

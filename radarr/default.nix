...
let
  ...
  hash = {
    x64-linux_hash = "sha256-Dqg8VFKXhOm/5Lr6omZOJKt1ump/+7APcbS9Cg9FVaQ=";
    arm64-linux_hash = "sha256-Pg8jUMGVlwQ6OFPZEV3HVNqw123Dmv3UoR9+70BCOro=";
    x64-osx_hash = "sha256-DIjL/XbOFx7sCCdmW7SFtaOYRrETDsEvvTTOo+gyEXc=";
  }."${arch}-${os}_hash";
